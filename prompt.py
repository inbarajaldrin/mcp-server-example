...
PROMPTS = {
    ...
    "pick_and_place": (
     ...
     "stack": (
         ...
         "Step 2: Get ROS2 topics and read topic info of one Jenga block to pick up from the real world.\n"
         "Step 3: Read the selected block's pose: x, y, z, rx, ry, rz.\n"
         "Step 4: Move UR end effector to x, y, (z=0.25) with orientation 0, 180, 0.\n"
         "Step 5: wait 2 seconds and then Read Jenga block pose again and calculate pick orientation:\n"
         "        - UR rz = (90 - Jenga rz) × -1\n"
         "        - Set ee orientation to 0, 180, (UR rz)\n"
         "Step 6: Move UR end effector to x, y, (z=0.15) with orientation 0, 180, (UR rz).\n"
         "Step 7: Close gripper to grasp the Jenga block.\n"
         "Step 8: ros2 topic echo /gripper_grasp_detected and check if its true. if the grasp was not detected, Go 5 cm up to get updated position of jenga . Try sending the open gripper once and then close grippercommand till /gripper_grasp_detected says true.\n"
         "Step 9: Move UR end effector to x, y, (z=0.25).\n"
         "Step 10: Calculate and set end effector orientation for final placement with target orientation {jenga_orientation} degrees:\n"
         "         - required_rotation = {jenga_orientation} - current_jenga_rz\n"
         "         - new_ee_rz = current_ee_rz + required_rotation\n"
         "         - Set orientation to 0, 180, (new_ee_rz)\n"
         "Step 11: Move UR end effector to final pose: {final_x}, {final_y}, 0.25 (drop position).\n"
         "Step 12: Run move_down mcp tool. \n"
         "Step 17: Return to pick station and repeat the process for all remaining Jenga blocks.\n"
         "Step 18 : move HOME_POSE = [0.065, -0.385, 0.481, 0, 180, 0] after there are no objects in the pick station \n"
     )
}
